...
let imgElements;
const linkPage =
  "https://www.google.com/search?q=anhr+gais&source=lnms&tbm=isch&sa=X&ved=2ahUKEwi84LbHpb_9AhVk3jgGHXs8AngQ_AUoAXoECAIQAw&biw=1280&bih=577&dpr=1.5";
(async () => {
  ...
  (async () => {
    ...
    // Use page.evaluate() to download the image
    await page.evaluate(
      (url, data) => {
...
//     let tempimgElements = document.querySelectorAll("img");
//     if (tempimgElements.length > 10)
//       imgElements = Array.from(tempimgElements).slice(0, 10);
//     else imgElements = tempimgElements;
//     console.log(imgElements);
//     imgElements = [...imgElements];
//     let imgLinks = imgElements.map(async (i) => {
//       i.getAttribute("src");
//       //============
//       const uint8Array = Uint8Array.from(atob(i.split(",")[1]), (c) =>
//         c.charCodeAt(0)
//       );
